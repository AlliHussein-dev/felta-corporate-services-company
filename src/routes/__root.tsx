  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "FELTA Corporate Services Provider — Abu Dhabi" },
      {
        ...
        content:
          "Premium business formation, residency, accounting and compliance advisory in Abu Dhabi.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=Inter:wght@300;400;500;600&family=Manrope:wght@400;500;600&display=swap",
      },
    ],
  }),
